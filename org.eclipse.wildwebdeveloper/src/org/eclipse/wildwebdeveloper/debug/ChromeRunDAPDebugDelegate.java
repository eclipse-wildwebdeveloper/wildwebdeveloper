...
public class ChromeRunDAPDebugDelegate extends DSPLaunchDelegate {
	...
	static final String ARGUMENTS = "runtimeArgs"; //$NON-NLS-1$
	...
	public void launch(ILaunchConfiguration configuration, String mode, ILaunch launch, IProgressMonitor monitor)
		...
		String argsString = configuration.getAttribute(NodeRunDAPDebugDelegate.ARGUMENTS, "").trim(); //$NON-NLS-1$
		...
		param.put("runtimeExecutable", findChromeLocation());
